  ...
  return (
    <main className="app-shell">
      <header className="page-header">
        <div>
          <p className="eyebrow">Contoh Lengkap Laravel + React</p>
      ...
      <section className="panel">
        <h2>Login</h2>
        <p className="small">
          Gunakan akaun admin seeded. Semua request CRUD dilindungi oleh frontend token
          dan Sanctum bearer token.
        </p>
      ...
      <section className="panel">
        <div className="section-header">
          <div>
            <h2>User profiles</h2>
            <p className="small">Seeded data mengandungi lima profiles dan related projects. Login sebelum load atau ubah rekod.</p>
          </div>
        ...
        <div className="profile-list">
          {profiles.length ? profiles.map((profile) => (
            ...
            <p className="empty-state">Login, kemudian load seeded profiles.</p>
          )}
        </div>
      </section>
