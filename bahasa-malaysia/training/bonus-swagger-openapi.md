...
Gunakan prompt ini jika peserta mahu Claude Code atau coding assistant lain memasang Swagger/OpenAPI dan mengisi dokumentasi API berdasarkan Laravel API semasa.

Rujukan folder contoh:
