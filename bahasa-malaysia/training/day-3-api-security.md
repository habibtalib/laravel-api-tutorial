...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withExceptions(function (Exceptions $exceptions): void {
        // Sanctum ability middleware throws an authorization error when the
        // token lacks the required ability. Return a clean JSON 403 for the API
        // instead of leaking the exception trace (which APP_DEBUG would expose).
